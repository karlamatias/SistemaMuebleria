        ...
        <div class="row">
            <div class="card col-md-4">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle mb-2 text-muted">En este panel podras gestionar los datos de la materia prima, las Piezas de madera</h6>
                    <div>
                        <form action="Controlador?accion=Piezas" method="POST">
                            
                            <div class="form-group">
                                <label>Nombre Producto</label>
                                <input type="text" class="form-control" name="txtnombre" value="${producto.getTipoPieza()}">
                            </div>
                            <div class="form-group">
                                <label>Correo</label>
